...
## Project Description (≥50 words — this one is ~140)

```
ClosrAI is an AI Sales Development Representative for B2B SaaS that does three
things no other sales bot does: it streams a transparent 7-dimensional Deal IQ
...
- **Source Code Repository** — public GitHub URL (must be **public**, not private).
- **Live Project URL** (optional but include it) — Vercel deployment URL.
